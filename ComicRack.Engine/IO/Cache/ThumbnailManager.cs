...
// Type: cYo.Projects.ComicRack.Engine.IO.Cache.ThumbnailManager
...
namespace cYo.Projects.ComicRack.Engine.IO.Cache
{
  public class ThumbnailManager : ImageManagerBase<ThumbnailImage>
  {
    ...
    {
      using (Bitmap image = provider.GetImage(key.Index))
        return ThumbnailImage.CreateFrom(image, image.Size);
    }
  }
}
