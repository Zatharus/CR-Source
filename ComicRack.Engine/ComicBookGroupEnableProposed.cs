...
// Type: cYo.Projects.ComicRack.Engine.ComicBookGroupEnableProposed
...
namespace cYo.Projects.ComicRack.Engine
{
  public class ComicBookGroupEnableProposed : SingleComicGrouper
  {
    ...
    {
      return !item.EnableProposed ? (IGroupInfo) new GroupInfo(this.captions[1], 1) : (IGroupInfo) new GroupInfo(this.captions[0], 0);
    }
  }
}
