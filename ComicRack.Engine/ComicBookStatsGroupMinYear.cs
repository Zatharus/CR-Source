...
// Type: cYo.Projects.ComicRack.Engine.ComicBookStatsGroupMinYear
...
namespace cYo.Projects.ComicRack.Engine
{
  public class ComicBookStatsGroupMinYear : SingleGrouper<ComicBookSeriesStatistics>
  {
    public override IGroupInfo GetGroup(ComicBookSeriesStatistics item)
    {
      ...
      return (IGroupInfo) new GroupInfo(string.IsNullOrEmpty(minYearAsText) ? GroupInfo.Unspecified : minYearAsText);
    }
  }
}
