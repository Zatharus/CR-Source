...
// Type: cYo.Projects.ComicRack.Viewer.Controls.PageViewItemKeyComparer
...
namespace cYo.Projects.ComicRack.Viewer.Controls
{
  public class PageViewItemKeyComparer : Comparer<PageViewItem>, IComparer<IViewableItem>
  {
    ...
    public override int Compare(PageViewItem x, PageViewItem y) => string.Compare(x.Key, y.Key);
  }
}
