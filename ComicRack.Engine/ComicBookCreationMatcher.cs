...
// Type: cYo.Projects.ComicRack.Engine.ComicBookCreationMatcher
...
{
  [System.ComponentModel.Description("File Created")]
  [ComicBookMatcherHint("FileCreationTime")]
  [Serializable]
  public class ComicBookCreationMatcher : ComicBookDateMatcher
  {
    public ComicBookCreationMatcher() => this.IgnoreTime = false;
