...
// Type: cYo.Common.Mathematics.Vector4Converter
...
namespace cYo.Common.Mathematics
{
  public class Vector4Converter : ExpandableObjectConverter
  {
      ...
      Type destinationType)
    {
      ...
      strArray[5] = str;
      num = vector4.W;
      strArray[6] = num.ToString((IFormatProvider) culture);
      ...
      object value)
    {
      ...
      try
      {
        ...
        return (object) new Vector4(float.Parse(strArray[0], (IFormatProvider) culture), float.Parse(strArray[1], (IFormatProvider) culture), float.Parse(strArray[2], (IFormatProvider) culture), float.Parse(strArray[3], (IFormatProvider) culture));
      }
      catch
      {
