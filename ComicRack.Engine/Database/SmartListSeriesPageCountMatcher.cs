...
// Type: cYo.Projects.ComicRack.Engine.Database.SmartListSeriesPageCountMatcher
...
{
  [System.ComponentModel.Description("Series: Pages")]
  ...
  public class SmartListSeriesPageCountMatcher : ComicBookNumericMatcher
  {
    ...
    {
      return this.StatsProvider == null ? 0.0f : (float) this.StatsProvider.GetSeriesStats(comicBook).PageCount;
    }
  }
}
